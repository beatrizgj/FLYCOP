...
# call: FLYCOPanalyzingResults_synKtPHA.sh 1 V2 'MaxPHA' 500
...
echo "sucrPer\tSynecho\tKT\tNH4\tfitness" > $dataAnalysisDir/tableParamWithFitness.csv
...
cp -p -R synKtPHA_TemplateOptimizeConsortium${templateID} synKtPHA_scenario${id}_optimalConfiguration
cd synKtPHA_scenario${id}_optimalConfiguration
python3 -W ignore ../../Scripts/synKtPHA_individualTestFLYCOP.py $param1 $param2 $param3 $param4 $fitness

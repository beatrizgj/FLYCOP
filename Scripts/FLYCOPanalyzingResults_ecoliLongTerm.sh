...
echo "glu1\tac1\to21\tglu2\tac2\to22\tfitness" > $dataAnalysisDir/tableParamWithFitness.csv
...
cp -p -R ecoliLongTerm_TemplateOptimizeConsortium${templateID} ecoliLongTerm_scenario${id}_optimalConfiguration
cd ecoliLongTerm_scenario${id}_optimalConfiguration
python3 -W ignore ../../Scripts/ecoliLongTerm_individualTestFLYCOP.py $param1 $param2 $param3 $param4 $param5 $param6 $fitness
